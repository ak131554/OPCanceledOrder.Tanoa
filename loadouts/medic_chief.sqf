...
for "_i" from 1 to 1 do {player addItemToVest "ACE_personalAidKit";};
for "_i" from 1 to 2 do {player addItemToVest "ACE_surgicalKit";};
for "_i" from 1 to 5 do {player addItemToVest "ACE_atropine";};
for "_i" from 1 to 12 do {player addItemToVest "ACE_epinephrine";};
